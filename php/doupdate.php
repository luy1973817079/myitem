...
$admin = $_SESSION['username'];
	...
	$sql = "UPDATE  u_article SET u_title = '$title',u_column = '$column',u_description = '$description', u_keywords = '$keywords',u_contents = '$contents' WHERE u_id = $id";
	...
	if( $_FILES['upfile']['error']==0 )
	{
		...
		$sql = "INSERT INTO u_article (u_title,u_column,u_description,u_keywords,u_contents,u_thumb,u_add_date,u_author) VALUES('$title','$column','$description','$keywords','$contents','$thumb','$dtime','$admin')";
