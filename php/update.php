        ...
        <div class="row">
			...
			?>
            	<div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="title" value="<?php echo $rows['u_title']; ?>">
                  </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" id="description" name="description"><?php echo $rows['u_description']; ?></textarea>
                  </div>
                <div class="form-group">
                    <label for="keywords">关键词</label>
                    <input type="text" class="form-control" id="keywords" name="keywords" value="<?php echo $rows['u_keywords']; ?>">
                  </div>
                  <h5>文章内容</h5>
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="exampleInputFile" name="upfile" value="<?php echo $rows['u_thumb']?>">
                 </div>
